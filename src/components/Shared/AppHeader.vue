  ...
  <div class="header-container">
    <nav class="flex w-full px-2">
      ...
      <div class="ml-auto flex items-center">
        <button v-if="_isAuthenticated" class="flex bg-gray-700 hover:bg-black text-white px-3 py-1 rounded-sm text-sm items-center mr-2" @click="$router.push({name:'NewBookmark'})">
